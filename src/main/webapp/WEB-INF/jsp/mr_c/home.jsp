...
<meta charset="utf-8">
<title>Mr.c</title>
<link rel="shortcut icon" type="image/x-icon" href="${dir}/static/images/heart.ico" media="screen" />
<link href="${dir }/static/css/mr_c.css" rel="stylesheet">
<!--[if lt IE 9]>
...
<body>
	...
	<div class="mainContent">
		<aside>
			...
			<section class="newpic">
				<h2>最新照片</h2>
				<ul>
					<li><a href="/"><img src="${dir}/static/images/mr01.jpg"></a></li>
					<li><a href="/"><img src="${dir}/static/images/mr02.jpg"></a></li>
					<li><a href="/"><img src="${dir}/static/images/mr03.jpg"></a></li>
					<li><a href="/"><img src="${dir}/static/images/mr04.jpg"></a></li>
					<li><a href="/"><img src="${dir}/static/images/mr05.jpg"></a></li>
					<li><a href="/"><img src="${dir}/static/images/mr06.jpg"></a></li>
					<li><a href="/"><img src="${dir}/static/images/mr07.jpg"></a></li>
					<li><a href="/"><img src="${dir}/static/images/mr08.jpg"></a></li>
				</ul>
			</section>
		...
		<div class="blogitem">
			<article>
				...
				<ul class="text">
					...
					<p class="textimg">
						<img src="${dir}/static/images/mrtext02.jpg">
					</p>
			...
			<article>
				...
				<ul class="text">
					...
					<p class="textimg">
						<img src="${dir}/static/images/mrtext01.jpg">
					</p>
	...
	<footer>
		<div class="footavatar">
			<img src="${dir}/static/images/mrphoto.jpg" class="footphoto">
			<ul class="footinfo">
				<p class="fname">
		...
		<section class="visitor">
			<h2>最近访客</h2>
			<ul>
				<li><a href="/"><img src="${dir}/static/images/mrs0.jpg"></a></li>
				<li><a href="/"><img src="${dir}/static/images/mrs1.jpg"></a></li>
				<li><a href="/"><img src="${dir}/static/images/mrs2.jpg"></a></li>
				<li><a href="/"><img src="${dir}/static/images/mrs3.jpg"></a></li>
				<li><a href="/"><img src="${dir}/static/images/mrs5.jpg"></a></li>
				<li><a href="/"><img src="${dir}/static/images/mrs6.jpg"></a></li>
				<li><a href="/"><img src="${dir}/static/images/mrs7.jpg"></a></li>
				<li><a href="/"><img src="${dir}/static/images/mrs8.jpg"></a></li>
			</ul>
		</section>
		<div class="Copyright">
			<ul>
