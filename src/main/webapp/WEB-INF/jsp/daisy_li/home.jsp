...
<head>
<meta charset="utf-8">
<title>Daisy_li</title>
<link rel="shortcut icon" type="image/x-icon" href="${dir }/static/${dir}/static/images/daisy_heart.ico" media="screen" /> 
<link href="${dir }/static/css/daisy_li.css" rel="stylesheet">
<!--[if lt IE 9]>
<script src="${dir }/static/js/modernizr.js"></script>
<![endif]-->
</head>
<body>
	<header>
		<nav id="nav">
			<ul>
				<li><a href="../">网站首页</a></li>
				<li><a href="/web/" target="_blank">关于我</a></li>
				<li><a href="/jstt/" target="_blank">我的故事</a></li>
				<li><a href="/newstalk/" target="_blank">我的相册</a></li>
				<li><a href="/news/jsex/" target="_blank">我的文章</a></li>
			</ul>
			<script src="${dir }/static/js/silder.js"></script>
			<!--获取当前页导航 高亮显示标题-->
		</nav>
	</header>
	<%-- <div class="mainContent">
		<div class="ulist">
			<section>
				<a href="#"> <img src="${dir}/static/images/daisy_s5.jpg"></a>
				<ul>
					<h2>
						<a href="#">执子之手，与子偕老</a>
					</h2>
			...
			<section>
				<a href="#"><img src="${dir}/static/images/daisy_s7.jpg"></a>
				<ul>
					<h2>
						<a href="#">陌上花开缓缓归</a>
					</h2>
			...
			<section>
				<a href="#"><img src="${dir}/static/images/daisy_text02.jpg"></a>
				<ul>
					<h2>
						<a href="#">岁月留痕之时光</a>
					</h2>
	...
	<div class="mainContent2">
		<aside>
			...
			<section class="newpic">
				<h2>最新照片</h2>
				<ul>
					<li><a href="/"><img src="${dir}/static/images/daisy_01.jpg"></a></li>
					<li><a href="/"><img src="${dir}/static/images/daisy_s3.jpg"></a></li>
					<li><a href="/"><img src="${dir}/static/images/daisy_s0.jpg"></a></li>
					<li><a href="/"><img src="${dir}/static/images/daisy_s2.jpg"></a></li>
					<li><a href="/"><img src="${dir}/static/images/daisy_s5.jpg"></a></li>
					<li><a href="/"><img src="${dir}/static/images/daisy_s6.jpg"></a></li>
					<li><a href="/"><img src="${dir}/static/images/daisy_s7.jpg"></a></li>
					<li><a href="/"><img src="${dir}/static/images/daisy_s8.jpg"></a></li>
				</ul>
			</section>
		...
		<div class="blogitem">
			<article>
				...
				<ul class="text">
					...
					<p class="textimg">
						<img src="${dir}/static/images/daisy_text02.jpg">
					</p>
			...
			<article>
				...
				<ul class="text">
					...
					<p class="textimg">
						<img src="${dir}/static/images/daisy_text01.jpg">
					</p>
	...
	<footer>
		<div class="footavatar">
			<img src="${dir}/static/images/daisy_s8.jpg" class="footphoto">
			<ul class="footinfo">
				<p class="fname">
					<a href="/dancesmile">青轻飞扬</a>
				</p>
		...
		<section class="visitor">
			...
			<ul>
				<li><a href="/"><img src="${dir}/static/images/daisy_s0.jpg"></a></li>
				<li><a href="/"><img src="${dir}/static/images/daisy_s1.jpg"></a></li>
				<li><a href="/"><img src="${dir}/static/images/daisy_s2.jpg"></a></li>
				<li><a href="/"><img src="${dir}/static/images/daisy_s3.jpg"></a></li>
				<li><a href="/"><img src="${dir}/static/images/daisy_s5.jpg"></a></li>
				<li><a href="/"><img src="${dir}/static/images/daisy_s6.jpg"></a></li>
